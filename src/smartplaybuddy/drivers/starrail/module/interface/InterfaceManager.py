...
def interface_switch(cx,cy):
    ...
    :return:
    """
    if not wait_until(common_img_path.joinpath("interstellar_guide.png"), timeout=5):
        print("当前不在星际和平指南界面")
        return None

    x,y = pos.get_target_pos(target_path=common_img_path.joinpath("interstellar_guide.png"))
